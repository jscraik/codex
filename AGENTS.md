...
- **Reference**: Refer to [docs/codex_architectural_handbook.md](./docs/codex_architectural_handbook.md) for canonical system architecture, API standards, and the technical debt registry.
